...
<body <?php body_class("scroll-smooth bg-white text-gray-900"); ?>>
    ...
    <?php if ($banners) : ?>
        <div class="relative w-full h-[120vh] !mb-[-280px] overflow-hidden" id="bannerCarousel">
            ...
            <?php foreach ($banners as $index => $banner) : ?>
                <div class="absolute inset-0 <?= $index === 0 ? 'opacity-100' : 'opacity-0'; ?> transition-opacity duration-[5000ms] ease-[cubic-bezier(0.4,0,0.2,1)] slide">
                    ...
                    <div class="absolute inset-0 bg-black/40 flex flex-col justify-center text-white">
                        <div class="container mx-auto px-4 md:px-8 lg:px-16 text-center md:!text-left">
            ...
            <button id="banner-prev" class="absolute left-4 top-1/2 transform -translate-y-1/2 bg-black/40 hover:bg-black/70 text-white rounded-full w-20 h-20 flex items-center justify-center transition-all z-20 !text-4xl">
                ❮
            </button>
            <button id="banner-next" class="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black/40 hover:bg-black/70 text-white rounded-full w-20 h-20 flex items-center justify-center transition-all z-20 !text-4xl">
                ❯
            </button>
        </div>
    <?php endif; ?>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            gsap.fromTo("#short-description-section", {
                ...
                scrollTrigger: {
                    ...
                    end: "top 20%", // termina más tarde
                    scrub: 2.5, // suaviza la interpolación (más lento = más suave)
                }
            });
            ...
            timeline.fromTo("#short-description__info", {
                xPercent: 0,
                opacity: 1
            }, {
                xPercent: -50,
            ...
            timeline.fromTo("#short-description__image", {
                xPercent: 0,
                opacity: 1
            }, {
                xPercent: 50,
