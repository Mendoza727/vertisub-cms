                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="hero-about-content" data-aos="fade-up">
                            ...
                            <h1 class="display-3 fw-bold text-white">Nuestras Certificaciones</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="certifications-section">
            <div class="container">
                ...
                <div class="section-header" data-aos="fade-up">
                    <span class="section-subtitle">Cursos Y Formaciones</span>
                    <h1 class="section-title">¿Qué quieres aprender hoy?</h1>
                    <p class="lead text-muted">Descubre y desarrolla tus nuevas habilidades de la mano de los mejores</p>
                </div>
                ...
                <div class="certifications-grid" id="certificationsGrid">
                    ...
                    if ($cursos->have_posts()):
                        while ($cursos->have_posts()): $cursos->the_post();
                            ...
                            $intro_video    = get_post_meta($curso_id, '_curso_intro_video', true);
                            $testimonios    = get_post_meta($curso_id, '_curso_testimonios', true) ?: [];
                    ...
                    ?>
                            ...
                            <div class="certification-card" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div class="expanded-content">
                                    ...
                                    <!-- Temario -->
                                    <div class="content-section">
                                        <h3><i class="fas fa-list-ul me-2"></i>Temario del Curso</h3>
                                    ...
                                    <!-- Instructores -->
                                    <div class="content-section">
                                        <h3><i class="fas fa-chalkboard-teacher me-2"></i>Nuestros Instructores</h3>
                                        <div class="instructores-grid">
                                            <?php
                                            if (!empty($instructores)) :
                                                foreach ($instructores as $inst_id) :
                                                    $inst_post = get_post($inst_id);
                                                    $foto_url  = get_the_post_thumbnail_url($inst_id, 'thumbnail') ?: 'https://via.placeholder.com/150';
                                                    $cargo     = get_post_meta($inst_id, '_instructor_cargo', true) ?: 'Instructor';
                                                    $video_url = get_post_meta($inst_id, '_instructor_video', true); // URL del video
                                            ?>
                                                    <div class="instructor-card">
                                                        <div class="instructor-photo"
                                                            onclick="openVideoModal('<?php echo esc_js($video_url); ?>')"
                                                            style="background-image: url('<?php echo esc_url($foto_url); ?>');">
                                                            <div class="video-overlay">
                                                                <i class="fas fa-play"></i>
                                                            </div>
                                                        </div>
                                                        <h5><?php echo esc_html($inst_post->post_title); ?></h5>
                                                        <p class="text-muted"><?php echo esc_html($cargo); ?></p>
                                                    </div>
                                                <?php
                                                endforeach;
                                            else :
                                                ?>
                                                <p>No hay instructores asignados para este curso.</p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="action-section">
                                        ...
                                        <div class="country-section">
                                            <h4>Selecciona tu país para el curso práctico</h4>
                                            <div class="country-select">
                                                <select class="form-select" onchange="updateCountryInfo(this.value)">
                                                    <option value="">Seleccionar país</option>
                                                    <?php
                                                    if (!empty($paises)) :
                                                        foreach ($paises as $pais_id) :
                                                            $pais_post = get_post($pais_id);
                                                            $pais_url  = isset($paises_urls[$pais_id]) ? $paises_urls[$pais_id] : '#';
                                                    ?>
                                                            <option value="<?php echo esc_attr($pais_id); ?>" data-url="<?php echo esc_url($pais_url); ?>">
                                                                <?php echo esc_html($pais_post->post_title); ?>
                                                            </option>
                                                    <?php
                                                        endforeach;
                                                    endif;
                                            ...
                                            <div id="countryInfo2" class="mt-3" style="display: none;">
                                                <a id="countryLink" href="#" class="btn-action btn-primary-action" target="_blank">
                                                    <i class="fas fa-map-marker-alt me-2"></i>Ver Sedes Disponibles
                                                </a>
                                            </div>
                                        </div>
                                    </div>
